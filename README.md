...
- Recent downloads list with quick access to where each file was saved
- Dark/light mode, clipboard monitoring, cookie support for private/age-restricted videos
- Advanced options: codec preference, container format, filesize/rate limits, custom user-agent
